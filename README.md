...
Так же была ошибка на одном из тестов, как я поняла потому, что в редис записывались эти данные в предыдущем тесте. Поэтому добавила удаление всего из редиса после каждого теста.
