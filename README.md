Сначала пробовала не нейронить, но в итоге нанейронила. 
Добавила кеширование, эндпойнт для удаления по топику, запись в конфиг настроек редиса. В конструктор сервиса теперь передается редис и ттл. 
Так же была ошибка на одном из тестов, как я поняла потому, что запись в редис записывались эти данные в предыдущем тесте. Поэтому добавила удаление всего из редиса после каждого теста.
